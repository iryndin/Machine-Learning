...
public class SplitUtils {
    ...
    public static List<DatasetSplit> generateSplits(DataSet dataset) {
        return generateSplits(dataset, dataset.getColumnNames());
    }

    public static List<DatasetSplit> generateSplits(DataSet dataset, Set<String> columnNames) {
        List<DatasetSplit> list = new ArrayList<>(columnNames.size());
